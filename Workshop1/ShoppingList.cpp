...
namespace seneca {
    ...
    ShoppingRec recs[MAX_NO_OF_RECS] = {};    //** I'm not sure to place this variable inside namespace seneca or nor ?
    int noOfRecs = 0;   //** I'm not sure to place this variable inside namespace seneca or nor ?
